  ...
  return (
    <div className="rounded-2xl border border-slate-200 dark:border-[#2a2a2a] bg-white dark:bg-[#141414] p-4">
      <div className="mb-3 flex items-center gap-2">
        ...
        <h3 className="text-sm font-semibold text-slate-900 dark:text-slate-100">Distribution des VMs</h3>
        {!loading && (
          conformant ? (
            <span className="ml-1 inline-flex items-center gap-1 rounded-full bg-emerald-50 dark:bg-emerald-500/15 px-2 py-0.5 text-[11px] text-emerald-700 dark:text-emerald-300">
              <CheckCircle2 size={12} /> conforme
            </span>
          ) : nodes.length > 0 ? (
            <span className="ml-1 inline-flex items-center gap-1 rounded-full bg-amber-100 dark:bg-amber-500/15 px-2 py-0.5 text-[11px] text-amber-700 dark:text-amber-300">
        ...
        <button
          ...
          className="ml-auto flex items-center gap-1.5 rounded-xl border border-violet-200 bg-violet-50 dark:bg-violet-500/15 px-3 py-1.5 text-[12px] text-violet-700 dark:text-violet-300 hover:bg-violet-100 disabled:opacity-40"
        >
      ...
      {loading ? (
        ...
        <p className="text-[12px] text-slate-500 dark:text-slate-400 dark:text-slate-500">
            ...
            return (
              <div key={n.node} className={`rounded-xl border bg-gradient-to-b to-transparent p-3 ${hostAccent(n.node)}`}>
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[12px] text-slate-600 dark:text-slate-400 dark:text-slate-500">
