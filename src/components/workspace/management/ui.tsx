...
export function MgmtView({ title, subtitle, actions, children }: {
  ...
  return (
    <div className="omega-grid-bg h-full overflow-y-auto px-6 py-5">
...
export const inputCls = 'w-full rounded-lg border border-slate-200 dark:border-[#2a2a2a] bg-white dark:bg-[#141414] px-3 py-2 text-[13px] text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 outline-none focus:border-cyan-500';
